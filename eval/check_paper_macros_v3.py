...
LITERAL_PENDING = [
    ...
    # re-keyed 2026-08-26 (second time today): the word-limit compression rewrote the clause
    # again, from 'they are domain-agnostic and score 0.00 on' to 'scoring 0.00 on'. Same
    # literal, same meaning, same debt. Earlier keys, kept for the record:
    #   'agnostic, scoring 0.00 on'  then  'domain-agnostic and score 0.00 on'
    ('0.00', 'scoring 0.00 on access control and CSRF'),
